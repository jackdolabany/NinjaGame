...
namespace NinjaGame
{
    public abstract class Menu
    {
        ...
        public virtual void Draw(SpriteBatch spriteBatch)
        {
            ...
            if (IsOverlay)
            {
                spriteBatch.Draw(Game1.simpleSprites, new Rectangle(0, 0, Game1.GAME_X_RESOLUTION, Game1.GAME_Y_RESOLUTION), Game1.whiteSourceRect, new Color(0f, 0f, 0f, 0.85f), 0f, Vector2.Zero, SpriteEffects.None, DrawDepth + 2 * Game1.MIN_DRAW_INCREMENT);
            }
